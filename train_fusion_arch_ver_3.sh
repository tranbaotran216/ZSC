...
conda activate zsc_test

which python
python -V

PROJECT_DIR="D:/projects/zsc" 
export PYTHONPATH="$PROJECT_DIR;$PROJECT_DIR/gdcount/groundingdino;$PROJECT_DIR/T2ICount;$PROJECT_DIR/CountGD;$PYTHONPATH"
...
if [ "$MODEL_ARCH_VER" -eq 3 ]; then
    SAVE_DIR="$PROJECT_DIR/checkpoints_dgdcount/model_arch_ver_${MODEL_ARCH_VER}_${FUSION_OPTION}"
    EXP_NAME="unet_gdino_text_only_arch_ver_${MODEL_ARCH_VER}_${FUSION_OPTION}"
else
